...
from .gateway_transport import McpGatewayTransport
...
def run_side_channel(
    ...
    *,
    ...
    try:
        ...
        client = client or McpGatewayTransport(config.gateway_url, timeout_ms=config.timeout_ms, api_key=config.api_key)
